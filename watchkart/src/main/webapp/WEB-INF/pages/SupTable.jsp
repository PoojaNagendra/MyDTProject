...
control.controller('mController', function($scope, $http){
               ...
               $http.get('GsonCon2').success(function(data, status, headers, config) {
            	   console.log(data);
...
<body>
 <h3 align="center" >Supplier Table</h3>
...
<th> <a class="btn btn-primary" href="sdelS?val={{p.sid}}">Delete</a></th>	</tr>
</table>
</br>
</br>
